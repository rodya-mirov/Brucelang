...
public interface ASTWalker {
    ...
    void typeFuncWalk(WalkFunctions<TypeFuncExprNode> walkFunctions);
    void typeFuncRefWalk(WalkFunctions<TypeFuncTypeRefNode> walkFunctions);
    void typeFuncCallWalk(WalkFunctions<TypeFuncCallNode> walkFunctions);
    ...
    void simpleTypeRefWalk(WalkFunctions<SimpleTypeReferenceNode> walkFunctions);
    void parTypeRefWalk(WalkFunctions<ParametrizedTypeReferenceNode> walkFunctions);
    void funcTypeRefWalk(WalkFunctions<FunctionTypeReferenceNode> walkFunctions);
