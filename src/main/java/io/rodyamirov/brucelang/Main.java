...
import io.rodyamirov.brucelang.staticanalysis.VariableDependencyAnalyzer;
...
public class Main {
    public static void main(String[] args) {
        ...
        VariableDependencyAnalyzer.Path
                worstPath = VariableDependencyAnalyzer.getWorstPath(program, "global.main");
